...
import { getVisualOffsets, shouldAddVisualOffsets } from "./floating-ui-dom-utils-getVisualOffsets";
import { unwrapElement } from "./floating-ui-dom-utils-unwrapElement";
import { getFrameElement } from "./floating-ui-utils-dom";
export function getBoundingClientRect(element, includeScale = false, isFixedStrategy = false, offsetParent) {

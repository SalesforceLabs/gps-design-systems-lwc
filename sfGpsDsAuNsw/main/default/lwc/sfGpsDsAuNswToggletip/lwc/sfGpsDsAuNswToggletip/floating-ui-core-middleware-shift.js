import { clamp, evaluate, getOppositeAxis, getSide, getSideAxis } from "./floating-ui-utils";
...
export const shift = (options = {}) => ({
    ...
    async fn(state) {
        ...
        const { mainAxis: checkMainAxis = true, crossAxis: checkCrossAxis = false, limiter = { fn: ({ x, y }) => ({ x, y }) }, ...detectOverflowOptions } = evaluate(options, state);
        const coords = { x, y };

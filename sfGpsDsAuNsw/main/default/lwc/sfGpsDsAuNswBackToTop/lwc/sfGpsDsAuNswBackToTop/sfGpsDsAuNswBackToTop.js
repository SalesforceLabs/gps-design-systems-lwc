...
export default class sfGpsDsAuNswBackToTop extends SfGpsDsElement {
    // @ts-ignore
    @api
    scrollOffset = 0;
    // @ts-ignore
    ...
    resize() {
        this._width = Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0);
        this._height = Math.max(document.documentElement.clientHeight || 0, window.innerHeight || 0);
    }
    /* lifecycle */
    constructor() {
        super();

...
export default class SfGpsDsAuNswAccordionGroup extends SfGpsDsElement {
    ...
    get computedClassName() {
        if (DEBUG) {
            console.debug(CLASS_NAME, "> get computedClassName");
        }
        const rv = {
            "nsw-accordion": true,
            ready: true,
        ...
        if (DEBUG)
            console.debug(CLASS_NAME, "> get computedClassName", JSON.stringify(rv));
        return rv;
    }
    get i18n() {
        return I18N;

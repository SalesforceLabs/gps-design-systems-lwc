...
const i18n = {
    ...
    rangeOverflow: "Value must be {0} or earlier", //labelRangeOverflow,
    rangeUnderflow: "Value must be {0} or later", //labelRangeUnderflow,
};
...
*/
    ...
    @api get min() {
        return this._min ? this._min : "00:00";
    }

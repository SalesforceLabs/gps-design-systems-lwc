...
export default class NswLookup extends LightningElement {
    @api label = i18n.none;
    ...
    renderedCallback() {
        if (!this._lookupElement) {
            const e = this._isDesktop ? "c-nsw-desktop-lookup" : "c-nsw-desktop-lookup"; // "lightning-lookup-desktop" : "lightning-lookup-mobile";
    ...
    _updateGetLookupRecordsWireConfig() {
        ...
        console.log('_updateGetLookupRecordsWireConfig', this._fieldApiName, this._targetApiName, this._requestParams);
    }

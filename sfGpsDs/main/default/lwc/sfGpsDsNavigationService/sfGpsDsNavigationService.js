...
export default class SfGpsDsNavigationService extends NavigationMixin(LightningElement) {
    // @ts-ignore
    @api
    navigateTo(type, config, state) {
        // @ts-ignore
    ...
    navigateNavMenu(menuEntry) {
        switch (menuEntry.Type) {
            ...
            case "NavigationalTopic":
                console.log("sfGpsDsNavigationService.navtopic", JSON.stringify(menuEntry));
                // TODO handle
                break;
    ...
    generateUrlNavMenu(menuEntry) {
        switch (menuEntry.Type) {
            ...
            case "NavigationalTopic":
                ...
                return new Promise((resolve) => resolve("#"));
            case "SalesforceObject":
                return this.generateUrl("standard__objectPage", {
                    objectApiName: menuEntry.Target,
                    actionName: "list"
                }, {
                    filterName: menuEntry.DefaultListViewId

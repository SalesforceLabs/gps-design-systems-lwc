 ...
 * @slot Content10
 */
export default class sfGpsDsFlexLwr extends SfGpsDsLwc {
    ...
    get computedFlexStyle() {
        return computeClass({
            ...
            "justify-content: center": this._justifyContent === JUSTIFYCONTENT_CENTER,
            "justify-content: flex-start": this._justifyContent === JUSTIFYCONTENT_FLEXSTART,
            "justify-content: flex-end": this._justifyContent === JUSTIFYCONTENT_FLEXEND,
            "justify-content: space-between": this._justifyContent === JUSTIFYCONTENT_SPACEBETWEEN,
            "justify-content: space-around": this._justifyContent === JUSTIFYCONTENT_SPACEAROUND,
            "justify-content: space-evenly": this._justifyContent === JUSTIFYCONTENT_SPACEEVENLY,

...
function normalizeReference(string) {
    return string
...
class InlineParser {
    ...
    scanDelims(cc) {
        let numdelims = 0;
        let charBefore, charAfter, ccAfter;
        let startpos = this.pos;
        let left_flanking, right_flanking, canOpen, canClose;
        let afterIsWhitespace, afterIsPunctuation, beforeIsWhitespace, beforeIsPunctuation;
            ...
            if (!closer.canClose) {
                ...
                if (closercc === C_ASTERISK ||
                    ...
                    if (!openerFound) {
                        ...
                        openerInl._literal = openerInl._literal.slice(0, openerInl._literal.length - useDelims);
                        closerInl._literal = closerInl._literal.slice(0, closerInl._literal.length - useDelims);

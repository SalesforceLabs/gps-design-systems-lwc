...
export class Parser {
    ...
    blocks = {
        document: {
            continue: function (_parser, container) {
                return 0;
            },
            finalize: function (_parser, block) { },
        ...
        item: {
            ...
            finalize: function (_parser, _block) { },
            canContain: function (t) {
                return t !== "item";
            },
            acceptsLines: false
        ...
        paragraph: {
            continue: function (parser, _container) {
    ...
    incorporateLine(ln) {
        ...
        let matchedLeaf = container.type !== "paragraph" && this.blocks[container.type].acceptsLines;
